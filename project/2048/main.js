var board = new Array(); //block number
var score = 0; //score
var has_conflicted = new Array(); //fix continue clean
var startx = 0; //mobile start x
var starty = 0; //mobile start y
var endx = 0; //mobile end x
var endy = 0; //mobile end y
